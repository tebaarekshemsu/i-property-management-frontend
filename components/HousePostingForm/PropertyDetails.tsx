    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) =>
            updateFormData({ condition: e.target.value as "fairly used" | "newly built" | "old and renovated" | "" })
          }
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => updateFormData({ propertyType: e.target.value as "apartment" | "condominium" })}
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
        >
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Furnish Status</label>
        <select
          value={formData.furnishStatus}
          onChange={(e) =>
            updateFormData({ furnishStatus: e.target.value as "furnished" | "semi furnished" | "unfurnished" })
          }
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
        >
